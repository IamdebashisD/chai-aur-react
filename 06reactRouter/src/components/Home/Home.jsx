        ...
        <div className="w-full mx-auto max-w-7xl">
            <aside className="relative mx-2 overflow-hidden text-black rounded-lg sm:mx-16 sm:py-16">
                ...
                <div className="absolute inset-0 w-full h-full pt-12 sm:my-20 sm:pt-1 ">
                    <img className="w-96" src="https://as1.ftcdn.net/v2/jpg/04/99/57/34/1000_F_499573413_1bQx95dNmnBFDDh8uIRSoPFoNicGZDkp.jpg" alt="image1" />
                </div>
            </aside>

            <div className="grid place-items-center sm:mt-20">
                <img className="w-48 sm:w-96" src="https://as1.ftcdn.net/v2/jpg/04/99/57/34/1000_F_499573413_1bQx95dNmnBFDDh8uIRSoPFoNicGZDkp.jpg" alt="image2" />
            </div>
